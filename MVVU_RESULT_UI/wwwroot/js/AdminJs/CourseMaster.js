...
function SubmitFormCedit() {
    ...
    if (flag) {
        ...
        var formData = new FormData();
            ...
            formData.append("IS_NEP", $("#IS_NEP").prop('checked')),
            formData.append("IS_ACTIVE", $("#IS_ACTIVE").prop('checked')),
                formData.append("RESULT_TYPE", $("#RESULT_TYPE").val()),
                formData.append("RESULT_PATTERN", $("#RESULT_PATTERN").val()),


            $.ajax({
                type: "POST",
                url: '/admin/dashboard/updatecoursemaster',
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
